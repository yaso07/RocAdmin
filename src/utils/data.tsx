...
export const typesData = [
    ...
    { title: "Family friendly", value: "family-friendly" },
    { title: "Couples", value: "couples" },
    { title: "History & Heritage", value: "history-and-heritage" },
    { title: "Participant", value: "participant" },
    { title: "Outdoor", value: "outdoor" },
    { title: "Festivals", value: "festivals" },
    { title: "Health & wellbeing", value: "health-and-wellbeing" },
...
export const BusRoutesData = [
    {
        value: "1",
        title: "Route 1<br><i>(Liberation Station - Gorey Pier)</i>",
        RouteInfo: "Liberation Station - Gorey Pier)",
    },
    {
        value: "1a",
        title: "Route 1A<br><i>(Liberation Station - Gorey Pier)</i>",
        RouteInfo: "Liberation Station - Gorey Pier)",
    },
    {
        value: "2",
        title: "Route 2<br><i>(Liberation Station - St. Catherine)</i>",
        RouteInfo: "Liberation Station - St. Catherine",
    },
    {
        value: "2a",
        title: "Route 2A<br><i>(Liberation Station - St. Catherine)</i>",
        RouteInfo: "Liberation Station - St. Catherine",
    },
    {
        value: "3",
        title: "Route 3<br><i>(Liberation Station - Jersey Zoo)</i>",
        RouteInfo: "Liberation Station - Jersey Zoo",
    },
    {
        value: "4",
        title: "Route 4<br><i>(Liberation Station - Bonne Nuit Bay)</i>",
        RouteInfo: "Liberation Station - Bonne Nuit Bay",
    },
    {
        value: "5",
        title: "Route 5<br><i>(Liberation Station - St. John's Church)</i>",
        RouteInfo: "Liberation Station - St. John's Church",
    },
    {
        value: "7",
        title: "Route 7<br><i>(Liberation Station - St. John's Church)</i>",
        RouteInfo: "Liberation Station - St. John's Church",
    },
    {
        value: "8",
        title: "Route 8<br><i>(Liberation Station - Plémont)</i>",
        RouteInfo: "Liberation Station - Plémont",
    },
    {
        value: "9",
        title: "Route 9<br><i>(Liberation Station - Grève De Lecq)</i>",
        RouteInfo: "Liberation Station - Grève De Lecq",
    },
    {
        value: "12a",
        title: "Route 12A<br><i>(Liberation Station - Corbière)</i>",
        RouteInfo: "Liberation Station - Corbière",
    },
    {
        value: "13",
        title: "Route 13<br><i>(Liberation Station - Jersey Zoo)</i>",
        RouteInfo: "Liberation Station - Jersey Zoo",
    },
    {
        value: "14",
        title: "Route 14<br><i>(Liberation Station - St. Brelade's Bay)</i>",
        RouteInfo: "Liberation Station - St. Brelade's Bay",
    },
    {
        value: "15",
        title: "Route 15<br><i>(Liberation Station - Jersey Airport)</i>",
        RouteInfo: "Liberation Station - Jersey Airport",
    },
    {
        value: "16",
        title: "Route 16<br><i>(Liberation Station - Liberation Station)</i>",
        RouteInfo: "Liberation Station - Liberation Station",
    },
    {
        value: "19",
        title: "Route 19<br><i>(Liberation Station - La Pouquelaye)</i>",
        RouteInfo: "Liberation Station - La Pouquelaye",
    },
    {
        value: "20",
        title: "Route 20<br><i>Town Link (Liberation Station - Halkett Place)</i>",
        RouteInfo: "Liberation Station - Halkett Place",
    },
    {
        value: "21",
        title: "Route 21<br><i>(Liberation Station - Liberation Station)</i>",
        RouteInfo: "Liberation Station - Liberation Station",
    },
    {
        value: "22",
        title: "Route 22<br><i>(Liberation Station - L'Etacq)</i>",
        RouteInfo: "Liberation Station - L'Etacq",
    },
    {
        value: "x22",
        title: "Route X22<br><i>(Liberation Station - L'Etacq)</i>",
        RouteInfo: "Liberation Station - L'Etacq",
    },
    {
        value: "23",
        title: "Route 23<br><i>(Liberation Station - Jersey Zoo)</i>",
        RouteInfo: "Liberation Station - Jersey Zoo",
    },
    {
        value: "23a",
        title: "Route 23A<br><i>(Liberation Station - St Martin's Hall)</i>",
        RouteInfo: "Liberation Station - St Martin's Hall",
    },
    {
        value: "24",
        title: "Route 24<br><i>Town Link (Liberation Station - Halkett Place)</i>",
        RouteInfo: "Liberation Station - Halkett Place",
    },
    {
        value: "28",
        title: "Route 28<br><i>(Liberation Station - La Mare Wine Estate)</i>",
