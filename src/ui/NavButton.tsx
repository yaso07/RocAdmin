...
const NavButton= ({children,...props}:Props) => {
  ...
  const className =`hover-color hover:bg-sky-600 outline transition-all duration-500 outline-sky-600 text-black list-none flex justify-center place-items-center h-8 w-[80px] font-sans rounded-md float-right underline-offset-4`
